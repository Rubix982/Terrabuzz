...
const ImageHeader = ({ children, style }) => {
    return (
        <div className={ImageHeaderStyling.cover}>
            <div className={ImageHeaderStyling.profilePicture}>
                <img className={ImageHeaderStyling.picture} src={MainProfilePicture} alt="" name='profile-picture' />
            </div>
            <div className={ImageHeaderStyling.plusSymbolPicture}>
                <img className={ImageHeaderStyling.plusSymbol} src={PlusSymbol} alt="" name='plus-symbol' />
            </div>
        </div>
    );
};
